            ...
            case 'aws':
                return (
                    <svg
                        ...
                        fill='currentColor'
                    >
                        <path d='M6.8 10c0 .3 0 .5.1.7.1.2.1.4.3.6 0 .1.1.1.1.2 0 .1 0 .2-.1.3l-.5.3c-.1.1-.2.1-.2.1-.1 0-.2 0-.3-.1-.1-.1-.2-.3-.3-.5-.1-.2-.2-.3-.3-.6-.7.9-1.7 1.3-2.8 1.3-.8 0-1.4-.2-1.9-.7-.5-.5-.7-1.1-.7-1.9 0-.8.3-1.5.9-2 .6-.5 1.4-.8 2.3-.8.3 0 .6 0 1 .1.3 0 .7.1 1.1.2v-.7c0-.8-.2-1.3-.5-1.6-.3-.3-.8-.5-1.6-.5-.3 0-.7 0-1 .1-.4.1-.7.2-1.1.3-.2.1-.3.1-.4.1-.1 0-.2-.1-.2-.3v-.5c0-.2 0-.3.1-.4.1-.1.2-.2.3-.2.4-.2.8-.3 1.3-.5.5-.1 1.1-.2 1.7-.2 1.3 0 2.2.3 2.8.9.6.6.9 1.5.9 2.7v3.6zm-3.9 1.5c.3 0 .6-.1 1-.2.3-.1.6-.3.9-.6.2-.2.3-.4.3-.6 0-.2.1-.5.1-.8v-.4c-.3-.1-.6-.1-.8-.2-.3 0-.6-.1-.8-.1-.6 0-1.1.1-1.3.4-.3.2-.4.6-.4 1.1 0 .4.1.7.3 1 .2.2.5.3.9.3zm6.3 0c-.2 0-.3 0-.4-.1-.1-.1-.2-.2-.2-.4l-2.3-7.4c0-.2-.1-.3-.1-.4 0-.2.1-.3.2-.3h1c.2 0 .3 0 .4.1.1.1.1.2.2.4l1.6 6.4 1.5-6.4c0-.2.1-.3.2-.4.1-.1.2-.1.4-.1h.8c.2 0 .3 0 .4.1.1.1.2.2.2.4l1.5 6.4 1.7-6.4c0-.2.1-.3.2-.4.1-.1.2-.1.4-.1h1c.2 0 .3.1.3.3 0 0 0 .1 0 .2 0 .1 0 .2-.1.3l-2.3 7.4c0 .2-.1.3-.2.4-.1.1-.2.1-.4.1h-.9c-.2 0-.3 0-.4-.1-.1-.1-.2-.2-.2-.4l-1.5-6.3-1.5 6.3c0 .2-.1.4-.2.4-.1.1-.2.1-.4.1h-.9zm8 .2c-.6 0-1.3-.1-1.9-.2-.4-.1-.8-.3-1.2-.4-.1-.1-.2-.2-.3-.3 0-.1-.1-.2-.1-.3v-.5c0-.2.1-.3.2-.3.1 0 .2 0 .2.1.1 0 .2.1.3.2.4.2.9.3 1.4.3.8 0 1.4-.1 1.8-.4.4-.3.6-.6.6-1.1 0-.3-.1-.6-.3-.9-.2-.2-.6-.5-1.2-.7l-1.8-.6c-.9-.3-1.6-.7-2-1.3-.4-.6-.6-1.2-.6-1.9 0-.6.1-1 .4-1.5.2-.4.6-.8 1-1.1.4-.3.9-.5 1.4-.7.5-.2 1.1-.2 1.7-.2.3 0 .6 0 .8.1.3 0 .6.1.8.2.2.1.5.2.7.2.2.1.4.2.5.3.1.1.2.2.2.3 0 .1.1.2.1.4v.5c0 .2-.1.3-.2.3-.1 0-.2 0-.4-.1-.7-.3-1.4-.5-2.2-.5-.7 0-1.3.1-1.7.4-.4.2-.6.6-.6 1.1 0 .3.1.6.4.9.3.3.7.5 1.4.8l1.8.6c.9.3 1.5.7 1.9 1.2.4.5.6 1.1.6 1.7 0 .6-.1 1.1-.4 1.5-.2.4-.6.8-1 1.2-.4.3-.9.6-1.5.7-.6.2-1.2.3-1.9.3z' />
                    </svg>
                );
            case 'azure':
                return (
...
const toolCategories: ToolCategory[] = [
    ...
    },
    {
        ...
        tools: [
            ...
            },
            {
                ...
                icon: '',
                nodeType: 'build_azure_pipelines',
            },
            {
                id: 'github-actions',
                name: 'GitHub Actions',
    ...
    },
    {
        ...
        tools: [
            {id: 'aws', name: 'AWS', icon: '', nodeType: 'deploy_aws'},
            {id: 'azure', name: 'Azure', icon: '', nodeType: 'deploy_azure'},
            {id: 'gcp', name: 'GCP', icon: '', nodeType: 'deploy_gcp'},
            {
                id: 'docker',
                name: 'Docker',
                icon: '',
                nodeType: 'release_docker',
            },
            {
                id: 'kubernetes',
                name: 'Kubernetes',
