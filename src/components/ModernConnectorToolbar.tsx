    ...
    >
        <defs>
            <linearGradient
                ...
                y2='100%'
            >
                <stop offset='0%' stopColor='#0171EC' />
                <stop offset='100%' stopColor='#005fca' />
            </linearGradient>
        </defs>
        <path
            strokeLinecap='round'
...
const connectorsByCategory = {
    nodes: [
        {
            ...
            label: 'Development',
            logo: (
                <svg className='w-8 h-8' fill='#10B981' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'QA/Staging',
            logo: (
                <svg className='w-8 h-8' fill='#F59E0B' viewBox='0 0 24 24'>
    ...
    plan: [
        ...
        },
        {
            ...
            label: 'Asana',
            logo: (
                <svg className='w-8 h-8' fill='#F06A6A' viewBox='0 0 24 24'>
    ...
    code: [
        ...
        },
        {
            ...
            label: 'Bitbucket',
            logo: (
                <svg className='w-8 h-8' fill='#0052CC' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            logo: (
                <svg className='w-8 h-8' fill='#809CC9' viewBox='0 0 24 24'>
                    <path d='M12 2L3 7v10l9 5 9-5V7l-9-5zm0 2.5L18 8.5v7L12 19.5 6 15.5v-7l6-4zm-3 5.5h6v1h-6v-1zm0 2h6v1h-6v-1zm0 2h4v1H9v-1z' />
                </svg>
            ),
        ...
        },
        {
            ...
            label: 'Mercurial',
            logo: (
                <svg className='w-8 h-8' fill='#999999' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'Perforce',
            logo: (
                <svg className='w-8 h-8' fill='#404040' viewBox='0 0 24 24'>
                    <path d='M2 3v18h20V3H2zm18 16H4V5h16v14zm-2-12H6v2h12V7zm0 4H6v2h12v-2zm-4 4H6v2h8v-2z' />
                </svg>
            ),
    ...
    build: [
        {
            ...
            label: 'Jenkins',
            logo: (
                <svg className='w-8 h-8' fill='#D33833' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            logo: (
                <svg className='w-8 h-8' fill='#2088FF' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            logo: (
                <svg className='w-8 h-8' fill='#0078D4' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'CircleCI',
            logo: (
                <svg className='w-8 h-8' fill='#343434' viewBox='0 0 24 24'>
                    <path d='M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 4.8c3.969 0 7.2 3.231 7.2 7.2s-3.231 7.2-7.2 7.2S4.8 15.969 4.8 12 8.031 4.8 12 4.8zm0 2.4c-2.651 0-4.8 2.149-4.8 4.8s2.149 4.8 4.8 4.8 4.8-2.149 4.8-4.8-2.149-4.8-4.8-4.8z' />
                </svg>
            ),
        ...
        },
        {
            ...
            label: 'Travis CI',
            logo: (
                <svg className='w-8 h-8' fill='#3EAAAF' viewBox='0 0 24 24'>
                    <path d='M12 0L4.5 7.5h4.2L12 4.2l3.3 3.3h4.2L12 0zm7.5 9L12 1.5 4.5 9v6L12 22.5 19.5 15V9zm-3 4.5L12 17.3l-4.5-3.8V9.8L12 13.5l4.5-3.7v4.7z' />
                </svg>
            ),
            description: 'Travis CI continuous integration',
        },
        {
            type: 'build_gitlab_ci',
            label: 'GitLab CI',
            logo: (
                <svg className='w-8 h-8' fill='#FCA326' viewBox='0 0 24 24'>
                    <path d='M12 21.42l3.684-11.333H8.316L12 21.42zm0 0l3.684-11.333h5.473L12 21.42zm0 0l-3.684-11.333H2.843L12 21.42zm0 0l-3.684-11.333H8.316L12 21.42zm9.158-11.333l-1.105-3.4c-.263-.808-1.386-.808-1.649 0l-1.105 3.4h3.859zm-18.316 0l1.105-3.4c.263-.808 1.386-.808 1.649 0l1.105 3.4H2.842z' />
                </svg>
            ),
        ...
        },
        {
            ...
            logo: (
                <svg className='w-8 h-8' fill='#000000' viewBox='0 0 24 24'>
                    <path d='M12 0L2 6v12l10 6 10-6V6L12 0zm0 3l7 4.2v1.6L12 12 5 8.8V7.2L12 3zm-7 7.2L12 14l7-3.8v5.6L12 20l-7-4.2v-5.6z' />
                </svg>
            ),
        ...
        },
        {
            ...
            logo: (
                <svg className='w-8 h-8' fill='#0052CC' viewBox='0 0 24 24'>
                    <path d='M12 2L3 7v10l9 5 9-5V7l-9-5zm0 2.5L18 8.5v1.8L12 14 6 10.3V8.5l6-4zm-6 7.8L12 16l6-3.7v3.4L12 19.5 6 15.7v-3.4z' />
                </svg>
            ),
    ...
    test: [
        {
            ...
            label: 'Jest',
            logo: (
                <svg className='w-8 h-8' fill='#C21325' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'Selenium',
            logo: (
                <svg className='w-8 h-8' fill='#43B02A' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'Cypress',
            logo: (
                <svg className='w-8 h-8' fill='#17202C' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'Mocha',
            logo: (
                <svg className='w-8 h-8' fill='#8D6748' viewBox='0 0 24 24'>
                    <path d='M12 0C8.5 0 5.7 2.8 5.7 6.3c0 1.8.8 3.4 2 4.5v8.9c0 1.8 1.5 3.3 3.3 3.3s3.3-1.5 3.3-3.3v-8.9c1.2-1.1 2-2.7 2-4.5C18.3 2.8 15.5 0 12 0zm0 2.3c2.2 0 4 1.8 4 4s-1.8 4-4 4-4-1.8-4-4 1.8-4 4-4zm-1.7 8.4h3.4v8.6c0 .9-.8 1.7-1.7 1.7s-1.7-.8-1.7-1.7v-8.6z' />
                </svg>
            ),
        ...
        },
        {
            ...
            label: 'Playwright',
            logo: (
                <svg className='w-8 h-8' fill='#2EAD33' viewBox='0 0 24 24'>
                    <path d='M12.5 2l9 5.5v9L12.5 22 3.5 16.5v-9L12.5 2zm0 2.5L6 8.2v7.6l6.5 3.7 6.5-3.7V8.2L12.5 4.5zm0 3L17 10v4l-4.5 2.5L8 14v-4l4.5-2.5zm0 2L10 11v2l2.5 1.5L15 13v-2l-2.5-1.5z' />
                </svg>
            ),
        ...
        },
        {
            ...
            label: 'TestNG',
            logo: (
                <svg className='w-8 h-8' fill='#FF6B35' viewBox='0 0 24 24'>
                    <path d='M12 2L3 7v10l9 5 9-5V7l-9-5zm0 2.5L18 8.5v7L12 19.5 6 15.5v-7l6-4zm-3 6h6v1h-6v-1zm0 2h6v1h-6v-1zm0 2h4v1H9v-1z' />
                </svg>
            ),
        ...
        },
        {
            ...
            label: 'Puppeteer',
            logo: (
                <svg className='w-8 h-8' fill='#40B883' viewBox='0 0 24 24'>
                    <path d='M12 2c-1.5 0-3 .5-4 1.5L6 5.5c-1 1-1.5 2.5-1.5 4v5c0 1.5.5 3 1.5 4l2 2c1 1 2.5 1.5 4 1.5s3-.5 4-1.5l2-2c1-1 1.5-2.5 1.5-4v-5c0-1.5-.5-3-1.5-4L16 3.5C15 2.5 13.5 2 12 2zm0 4c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm-3 8c0-1.7 1.3-3 3-3s3 1.3 3 3H9z' />
                </svg>
            ),
    ...
    deploy: [
        {
            ...
            label: 'Kubernetes',
            logo: (
                <svg className='w-8 h-8' fill='#326CE5' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'Google Cloud',
            logo: (
                <svg className='w-8 h-8' fill='#4285F4' viewBox='0 0 24 24'>
    ...
    approval: [
        {
            ...
            label: 'Manual',
            logo: (
                <svg className='w-8 h-8' fill='#6B7280' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'Slack',
            logo: (
                <svg className='w-8 h-8' fill='#4A154B' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'Teams',
            logo: (
                <svg className='w-8 h-8' fill='#6264A7' viewBox='0 0 24 24'>
    ...
    release: [
        {
            ...
            label: 'Docker',
            logo: (
                <svg className='w-8 h-8' fill='#2496ED' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'NPM',
            logo: (
                <svg className='w-8 h-8' fill='#CB3837' viewBox='0 0 24 24'>
        ...
        },
        {
            ...
            label: 'Maven',
            logo: (
                <svg className='w-8 h-8' fill='#C71A36' viewBox='0 0 24 24'>
...
const toolbarCategories = [
    ...
    },
    {
        ...
        name: 'Code',
        icon: CodeIcon,
        color: 'text-primary-700 hover:text-primary-800',
        bgColor: 'hover:bg-primary-50',
        borderColor: 'hover:border-primary-200',
    },
    {
                            ...
                            {connectorsByCategory[
                                ...
                                >
                                    ...
                                    <div className='flex-1 min-w-0'>
                                        <div className='font-semibold text-gray-800 text-sm group-hover:text-primary-600 transition-colors'>
                                            {connector.label}
                                        </div>
