...
export const deviceRender = {
    mobile: <T>(component: T, fallback?: T): T | undefined =>
        isMobile() ? component : fallback,
    tablet: <T>(component: T, fallback?: T): T | undefined =>
        isTablet() ? component : fallback,
    desktop: <T>(component: T, fallback?: T): T | undefined =>
        isDesktop() ? component : fallback,
    touch: <T>(component: T, fallback?: T): T | undefined =>
        isTouchDevice() ? component : fallback,
    nonTouch: <T>(component: T, fallback?: T): T | undefined =>
        !isTouchDevice() ? component : fallback,
};
