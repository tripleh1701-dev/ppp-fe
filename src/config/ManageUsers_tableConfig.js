...
const ManageUsers_tableConfig = {
    ...
    api: {
        ...
        endpoints: {
            create: 'http://localhost:4000/api/user',
            update: 'http://localhost:4000/api/user/{id}',
            delete: 'http://localhost:4000/api/user/{id}',
            bulkCreate: 'http://localhost:4000/api/user/bulk',
            bulkUpdate: 'http://localhost:4000/api/user/bulk',
            bulkDelete: 'http://localhost:4000/api/user/bulk',
        },
        autoSave: {
            enabled: true,
            debounceMs: 1000,
