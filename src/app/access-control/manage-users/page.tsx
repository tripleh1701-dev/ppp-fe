            ...
            {showUserTable && (
                ...
                >
                    <style jsx>{`
                        ...
                        /* Target the actual header elements */
                        :global(.column-header) {
                            font-weight: 700 !important;
                            color: #1f2937 !important;
                        }
                        :global(.table-header .column-header) {
                            font-weight: 700 !important;
                            color: #1f2937 !important;
                        }
                        .table-container :global(.checkbox-cell) {
                            padding: 2px 4px !important;
                            width: 40px !important;
                            max-width: 40px !important;
                            text-align: center !important;
                        }
                        .table-container :global(.checkbox-column) {
                            width: 40px !important;
                            max-width: 40px !important;
                            padding: 2px 4px !important;
                            text-align: center !important;
                        }
                        .table-container :global(.task-checkbox) {
                        ...
                        .table-container :global(.task-row:active) {
                            cursor: grabbing !important;
                            transition: none !important;
                        }
                        .table-container
                            :global(.task-row[data-is-dragging='true']) {
                            cursor: grabbing !important;
                        ...
                        .table-container
                            :global(.task-row[data-is-over='true']) {
                            background-color: #e3f2fd !important;
                            border-top: 2px solid #4ba3ff !important;
                            transform: translateY(-1px) !important;
                        ...
                        .table-container :global(.add-task-row) {
                            min-height: 36px !important;
                            height: 36px !important;
                        }
                        .table-container :global(.table-header) {
                            height: 32px !important;
                        }
                        ...
                        .table-container
                            :global(
                                .task-row[data-is-over='true']:not(
                                        [data-is-dragging='true']
                                    )
                            ) {
                            animation: dropZonePulse 0.3s ease-in-out !important;
                        }
                        ...
                        /* Empty state styling - show only + Add item without blank row */
                        .table-container :global(.task-group) {
                            margin: 0 !important;
                            padding: 0 !important;
                        }
                        .table-container :global(.table-header) {
                        ...
                        .table-container :global(.task-board) {
                            margin: 0 !important;
                            padding: 0 !important;
                        }
                        .table-container {
                        ...
                        .table-container :global(.add-task-row.empty-state) {
                        ...
                        .table-container
                            :global(.add-task-row.empty-state:hover) {
                            border-color: #4ba3ff !important;
                            background-color: #f0f8ff !important;
                        }
                        .table-container
                            :global(.add-task-row.empty-state .task-cell) {
                            display: none !important;
                        }
                        .table-container
                            :global(.add-task-row.empty-state .task-name) {
                            display: flex !important;
                            align-items: center !important;
                            justify-content: flex-start !important;
                        }
                        .table-container
                            :global(.add-task-row.empty-state .add-task-input) {
                            color: #64748b !important;
                            font-size: 14px !important;
                            font-weight: 500 !important;
                        }
                        /* Placeholder styling - target all possible selectors */
                        .table-container :global(input::placeholder),
                        .table-container :global(textarea::placeholder) {
                        ...
                        .table-container
                            :global(.task-cell input::placeholder) {
                            color: #d1d5db !important;
                            font-size: 9px !important;
                            opacity: 0.6 !important;
                            font-weight: 400 !important;
                        }
                        .table-container :global(.task-input::placeholder) {
                            color: #d1d5db !important;
                            font-size: 9px !important;
                            opacity: 0.6 !important;
                            font-weight: 400 !important;
                        }
                        .table-container :global(.add-task-input::placeholder) {
                            color: #d1d5db !important;
                            font-size: 9px !important;
                            opacity: 0.6 !important;
                            font-weight: 400 !important;
                        ...
                        :global(.add-task-input::placeholder) {
                            color: #d1d5db !important;
                            font-size: 9px !important;
                            opacity: 0.6 !important;
                            font-weight: 400 !important;
                        ...
                        /* Remove gap between header and rows */
                        :global(.task-group) {
                            gap: 0 !important;
                            margin: 0 !important;
                            padding: 0 !important;
