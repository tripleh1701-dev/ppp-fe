...
const fioriAppPipeline: PipelineStep[] = [
    {
        id: 'source',
        title: 'Source Code',
        description: 'Pull Fiori application code from Git repository',
        type: 'source',
        icon: 'git',
        config: {
            repository: 'https://github.com/your-org/fiori-app',
            branch: 'main',
    ...
    },
    {
        ...
        description: 'Install UI5 tooling and project dependencies',
        type: 'build',
        icon: 'package',
        config: {
            commands: ['npm install', 'npm install -g @ui5/cli'],
            nodeVersion: '18.x',
        },
    },
    {
        id: 'build',
        title: 'Build UI5 Application',
        description: 'Build Fiori application with UI5 tooling',
        type: 'build',
        icon: 'build',
        config: {
            buildTool: 'UI5 CLI',
    ...
    },
    {
        ...
        description: 'Deploy to BTP test subaccount',
        type: 'deploy',
        icon: 'test-deploy',
        config: {
            environment: 'Test',
            destination: 'BTP Test Subaccount',
            appRouter: true,
        },
    },
    {
        ...
        config: {
            ...
            criteria: ['All tests passed', 'UX review completed'],
        },
    },
    {
        id: 'deploy-prod',
        title: 'Deploy to Production',
        description: 'Deploy to BTP production subaccount',
        type: 'deploy',
        icon: 'prod-deploy',
        config: {
            environment: 'Production',
            destination: 'BTP Production Subaccount',
            launchpadIntegration: true,
        },
    },
];
...
export default function FioriAppTemplate() {
    return (
                ...
                <div className='max-w-6xl mx-auto'>
                    <div className='flex items-center justify-between'>
                            ...
                            <div className='flex items-center'>
                                ...
                                <div>
                                    <h1 className='text-3xl font-bold text-gray-900'>
                                        Fiori Application Pipeline
                                    </h1>
                                    <p className='text-gray-600 mt-1'>
                                        Build and deploy Fiori applications with
                                        UI5 tooling and BTP deployment
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className='flex space-x-3'>
                            <Link
                                href='/pipelines/canvas?template=fiori-app'
                    ...
                    <div className='mb-8'>
                        ...
                        <div className='relative'>
                            <div className='space-y-6'>
                                {fioriAppPipeline.map((step, index) => (
                                    <div key={step.id} className='relative'>
                                        {index <
                                            fioriAppPipeline.length - 1 && (
