...
import manageAccountsTableConfig from '@/config/ManageAccounts_tableConfig';
                            ...
                            >
                                ...
                                {searchTerm && (
                                    <button
                                        ...
                                        className='absolute right-1 top-1/2 -translate-y-1/2 h-6 w-6 rounded hover:bg-slate-100 text-slate-500'
                ...
                {showCreateForm ? (
                    ...
                    <div className='space-y-6'>
                        {sortedAccounts.length === 0 ? (
                            ...
                            <div className='bg-card rounded-xl border border-light p-3 max-w-full overflow-hidden'>
                                <style jsx>{`
                                ...
                                <ReusableTableComponent
                                    config={(() => {
                                        const configWithData = {
                                            ...manageAccountsTableConfig,
                                            initialData: sortedAccounts.map(
                                                (a: any) => ({
                                                    id: a.id || '',
                                                    name: a.accountName || '',
                                                    account:
